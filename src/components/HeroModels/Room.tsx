...
Command: npx gltfjsx@6.5.3 room.glb --types 
*/
...
export default function Room(props: React.JSX.IntrinsicElements['group']) {
  const screensRef = React.useRef<THREE.Mesh>(null);
